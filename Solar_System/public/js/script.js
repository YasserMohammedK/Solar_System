...
// allow the user to control the intensity of the light
...
function tick() {
  ...
  if(flag) {
    // allow the user to control the orbit speed
    speedFolder.add(parameters,'magnitude')
    .min(0.0001)
    .max(0.0061)
    .step(0.0001)
    .name('Orbit Speed');

    // allow the user to control the rotation speed
    speedFolder.add(parameters,'rotationSpeed')
    .min(0.01)
    .max(0.5)
    .step(0.01)
    .name('rotation speed');
